(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.48',test:()=>window.__lyAppVersion?.version==='3.0.48'},
    ...
    vibeBusinessWrites:{src:'./ly-vibe-business-writes.js?v=20260920.5',test:()=>window.__lyVibeBusinessWrites?.version==='2026.09.20.5'&&!window.__lyVibeBusinessWrites?.installing},
