(()=>{
  ...
  const modules={
    tableFirstPaint:{src:'./ly-table-first-paint.js?v=20260907.1',test:()=>window.__lyTableFirstPaint?.version==='2026.09.07.1'},
    uiTableErgonomics:{src:'./ly-ui-table-ergonomics.js?v=20260920.1',test:()=>window.__lyUITableErgonomics?.version==='2026.09.20.1'},
    ...
    appVersion:{src:'./ly-app-version.js?v=3.3.11',test:()=>window.__lyAppVersion?.version==='3.3.11'},
    ...
    localAssistant:{src:'./ly-local-chatbot.js?v=20260921.3',test:()=>window.__lyLocalAssistant?.version==='2026.09.21.3'},
    chatLanguagePlus:{src:'./ly-chat-language-plus.js?v=20260921.1',test:()=>window.__lyChatLanguagePlus?.version==='2026.09.21.1'},
    ...
    vibeReadCache:{src:'./ly-vibe-read-cache.js?v=20260925.2',test:()=>window.__lyVibeReadCache?.version==='2026.09.25.2'},
    vibeBusinessWrites:{src:'./ly-vibe-business-writes.js?v=20260925.2',test:()=>window.__lyVibeBusinessWrites?.version==='2026.09.25.2'&&!window.__lyVibeBusinessWrites?.installing},
    ...
    menuSecurity:{src:'./ly-menu-security.js?v=20260921.2',test:()=>window.__lyMenuSecurity?.version==='2026.09.21.2'},
    ...
    cashflowTakeover:{src:'./ly-fresh-core-v2-cashflow-takeover.js?v=20260919.1',test:()=>window.__lyFreshCoreV2CashflowTakeover?.version==='2026.09.19.1'},
    ...
    readTakeover:{src:'./ly-fresh-core-v2-read-takeover.js?v=20260909.1',test:()=>window.__lyFreshCoreV2ReadTakeover?.version==='2026.09.09.1'},
    ...
    stockUnitSync:{src:'./ly-stock-unit-sync.js?v=20260922.1',test:()=>window.__lyStockUnitSync?.version==='2026.09.22.1'},
    ...
    dataNotifications:{src:'./ly-data-notifications.js?v=20260924.1',test:()=>window.__lyDataActivityNotifications?.version==='2026.09.24.1'},
    ...
    performanceOptimizer:{src:'./ly-performance-optimizer.js?v=20260924.1',test:()=>window.__lyPerformanceOptimizer?.version==='2026.09.24.1'},
    ...
    settings:{src:'./ly-settings-enhancements.js?v=20260921.3',test:()=>window.__lySettingsEnhancements?.version==='2026.09.21.3'},
    ...
    activityHistory:{src:'./ly-activity-history.js?v=20260921.4',test:()=>window.__lyActivityHistoryModule?.version==='2026.09.21.4'},
    ...
    cashflowUI:{src:'./ly-cashflow.js?v=20260920.4',test:()=>window.__lyCashflowModule?.version==='2026.09.20.4'}
  };
  ...
  async function loadAssistant(){await load('localAssistant');await load('chatLanguagePlus');await load('chatLegacyInventoryUnitGuard');await load('chatResponseGate');await load('chatUnitSync');}
