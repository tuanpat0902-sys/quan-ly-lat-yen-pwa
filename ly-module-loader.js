(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.32',test:()=>window.__lyAppVersion?.version==='3.0.32'},
    ...
    vibeBusinessWrites:{src:'./ly-vibe-business-writes.js?v=20260908.2',test:()=>window.__lyVibeBusinessWrites?.version==='2026.09.08.2'},
