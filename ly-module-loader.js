(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.18',test:()=>window.__lyAppVersion?.version==='3.0.18'},
    ...
    vibeReadCache:{src:'./ly-vibe-read-cache.js?v=20260906.1',test:()=>window.__lyVibeReadCache?.version==='2026.09.06.1'},
