(()=>{
  'use strict';
  if(window.__lyModuleLoaderV40)return;
  window.__lyModuleLoaderV40=true;

  const VERSION='2026.08.24.40';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.41',test:()=>window.__lyAppVersion?.version==='2.1.41'},
