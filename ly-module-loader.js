(()=>{
  'use strict';
  if(window.__lyModuleLoaderV78)return;
  window.__lyModuleLoaderV78=true;

  const VERSION='2026.08.27.29';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.5',test:()=>window.__lyAppVersion?.version==='3.0.5'},
