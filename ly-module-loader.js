(()=>{
  'use strict';
  if(window.__lyModuleLoaderV69)return;
  window.__lyModuleLoaderV69=true;

  const VERSION='2026.08.27.20';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.81',test:()=>window.__lyAppVersion?.version==='2.1.81'},
