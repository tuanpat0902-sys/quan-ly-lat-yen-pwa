(()=>{
  'use strict';
  if(window.__lyModuleLoaderV42)return;
  window.__lyModuleLoaderV42=true;

  const VERSION='2026.08.24.42';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.42',test:()=>window.__lyAppVersion?.version==='2.1.42'},
    localAssistant:{src:'./ly-local-chatbot.js?v=20260824.1',test:()=>window.__lyLocalAssistant?.version==='2026.08.24.1'},
