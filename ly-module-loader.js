(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.15',test:()=>window.__lyAppVersion?.version==='3.0.15'},
    ...
    realtime:{src:'./ly-fresh-core-v2-realtime.js?v=20260901.2',test:()=>window.__lyFreshCoreV2Realtime?.version==='2026.09.01.2'},
