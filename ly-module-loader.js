(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.28',test:()=>window.__lyAppVersion?.version==='3.0.28'},
    ...
    financeUI:{src:'./ly-finance.js?v=20260908.2',test:()=>window.__lyFinanceModule?.version==='2026.09.08.2'},
