(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.36',test:()=>window.__lyAppVersion?.version==='3.0.36'},
    ...
    vibeReadCache:{src:'./ly-vibe-read-cache.js?v=20260908.3',test:()=>window.__lyVibeReadCache?.version==='2026.09.08.3'},
    vibeBusinessWrites:{src:'./ly-vibe-business-writes.js?v=20260909.3',test:()=>window.__lyVibeBusinessWrites?.version==='2026.09.09.3'&&!window.__lyVibeBusinessWrites?.installing},
