(()=>{
  'use strict';
  if(window.__lyModuleLoaderV72)return;
  window.__lyModuleLoaderV72=true;

  const VERSION='2026.08.27.23';
  ...
  const modules={
    ...
    freshCoreV3Runtime:{src:'./ly-fresh-core-v3-runtime.js?v=20260827.1',test:()=>window.__lyFreshCoreV3Runtime?.version==='2026.08.27.1'},
    appVersion:{src:'./ly-app-version.js?v=2.1.84',test:()=>window.__lyAppVersion?.version==='2.1.84'},
    ...
    settings:{src:'./ly-settings-enhancements.js?v=20260827.2',test:()=>window.__lyNotificationMaster?.version==='2026.08.27.2'},
