(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.56',test:()=>window.__lyAppVersion?.version==='2.1.56'},
    localAssistant:{src:'./ly-local-chatbot.js?v=20260825.11',test:()=>window.__lyLocalAssistant?.version==='2026.08.25.11'},
