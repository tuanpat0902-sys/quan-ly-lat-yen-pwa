(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.63',test:()=>window.__lyAppVersion?.version==='2.1.63'},
    localAssistant:{src:'./ly-local-chatbot.js?v=20260825.17',test:()=>window.__lyLocalAssistant?.version==='2026.08.25.17'},
    ...
    employeesUI:{src:'./ly-employees.js?v=20260825.3',test:()=>window.__lyEmployeesModule?.version==='2026.08.25.3'},
