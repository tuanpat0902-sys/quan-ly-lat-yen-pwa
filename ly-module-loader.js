(()=>{
  'use strict';
  if(window.__lyModuleLoaderV73)return;
  window.__lyModuleLoaderV73=true;

  const VERSION='2026.08.27.24';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.0',test:()=>window.__lyAppVersion?.version==='3.0.0'},
