(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.3.0',test:()=>window.__lyAppVersion?.version==='3.3.0'},
    ...
    vibeReadCache:{src:'./ly-vibe-read-cache.js?v=20260921.4',test:()=>window.__lyVibeReadCache?.version==='2026.09.21.4'},
    vibeBusinessWrites:{src:'./ly-vibe-business-writes.js?v=20260921.2',test:()=>window.__lyVibeBusinessWrites?.version==='2026.09.21.2'&&!window.__lyVibeBusinessWrites?.installing},
