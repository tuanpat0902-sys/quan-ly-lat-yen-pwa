(()=>{
  'use strict';
  if(window.__lyModuleLoaderV77)return;
  window.__lyModuleLoaderV77=true;

  const VERSION='2026.08.27.28';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.4',test:()=>window.__lyAppVersion?.version==='3.0.4'},
    ...
    settings:{src:'./ly-settings-enhancements.js?v=20260827.3',test:()=>window.__lyNotificationMaster?.version==='2026.08.27.3'},
