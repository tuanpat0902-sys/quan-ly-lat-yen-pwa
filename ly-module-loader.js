(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.47',test:()=>window.__lyAppVersion?.version==='3.0.47'},
    ...
    vibeBusinessWrites:{src:'./ly-vibe-business-writes.js?v=20260920.4',test:()=>window.__lyVibeBusinessWrites?.version==='2026.09.20.4'&&!window.__lyVibeBusinessWrites?.installing},
    ...
    cashflowUI:{src:'./ly-cashflow.js?v=20260920.3',test:()=>window.__lyCashflowModule?.version==='2026.09.20.3'}
  };
