(()=>{
  'use strict';
  if(window.__lyModuleLoaderV61)return;
  window.__lyModuleLoaderV61=true;

  const VERSION='2026.08.27.12';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.74',test:()=>window.__lyAppVersion?.version==='2.1.74'},
