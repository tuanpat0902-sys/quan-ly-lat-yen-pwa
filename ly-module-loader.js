(()=>{
  'use strict';
  if(window.__lyModuleLoaderV75)return;
  window.__lyModuleLoaderV75=true;

  const VERSION='2026.08.27.26';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.2',test:()=>window.__lyAppVersion?.version==='3.0.2'},
