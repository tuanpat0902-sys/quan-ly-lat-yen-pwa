(()=>{
  'use strict';
  if(window.__lyModuleLoaderV59)return;
  window.__lyModuleLoaderV59=true;
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.72',test:()=>window.__lyAppVersion?.version==='2.1.72'},
