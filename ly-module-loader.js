(()=>{
  'use strict';
  if(window.__lyModuleLoaderV60)return;
  window.__lyModuleLoaderV60=true;

  const VERSION='2026.08.27.11';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.73',test:()=>window.__lyAppVersion?.version==='2.1.73'},
