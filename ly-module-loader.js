(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.45',test:()=>window.__lyAppVersion?.version==='3.0.45'},
    ...
    cashflowUI:{src:'./ly-cashflow.js?v=20260920.2',test:()=>window.__lyCashflowModule?.version==='2026.09.20.2'}
  };
