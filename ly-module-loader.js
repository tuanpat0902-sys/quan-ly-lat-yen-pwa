(()=>{
  'use strict';
  if(window.__lyModuleLoaderV96)return;
  window.__lyModuleLoaderV96=true;
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.19',test:()=>window.__lyAppVersion?.version==='3.0.19'},
    ...
    vibeReadCache:{src:'./ly-vibe-read-cache.js?v=20260906.2',test:()=>window.__lyVibeReadCache?.version==='2026.09.06.2'},
