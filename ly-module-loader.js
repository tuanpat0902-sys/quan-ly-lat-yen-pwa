(()=>{
  'use strict';
  if(window.__lyModuleLoaderV64)return;
  window.__lyModuleLoaderV64=true;

  const VERSION='2026.08.27.15';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.77',test:()=>window.__lyAppVersion?.version==='2.1.77'},
