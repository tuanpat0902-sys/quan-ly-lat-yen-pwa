(()=>{
  'use strict';
  if(window.__lyModuleLoaderV44)return;
  window.__lyModuleLoaderV44=true;

  const VERSION='2026.08.24.44';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.43',test:()=>window.__lyAppVersion?.version==='2.1.43'},
    localAssistant:{src:'./ly-local-chatbot.js?v=20260824.3',test:()=>window.__lyLocalAssistant?.version==='2026.08.24.3'},
