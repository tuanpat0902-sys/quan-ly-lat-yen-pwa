(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.61',test:()=>window.__lyAppVersion?.version==='2.1.61'},
    ...
    employeesUI:{src:'./ly-employees.js?v=20260825.2',test:()=>window.__lyEmployeesModule?.version==='2026.08.25.2'},
