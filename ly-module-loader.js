(()=>{
  ...
  const modules={
    ...
    ingredientConversionSync:{src:'./ly-ingredient-conversion-sync.js?v=20260825.3',test:()=>window.__lyIngredientConversionSync?.version==='2026.08.25.3'},
  ...
  async function loadCore(){
    ...
    await load('ingredientConversionSync');await load('stockUnitSync');
