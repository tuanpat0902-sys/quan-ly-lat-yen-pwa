(()=>{
  'use strict';
  if(window.__lyModuleLoaderV76)return;
  window.__lyModuleLoaderV76=true;

  const VERSION='2026.08.27.27';
  ...
  const modules={
    ...
    freshCoreV3Runtime:{src:'./ly-fresh-core-v3-runtime.js?v=20260827.3',test:()=>window.__lyFreshCoreV3Runtime?.version==='2026.08.27.3'},
    appVersion:{src:'./ly-app-version.js?v=3.0.3',test:()=>window.__lyAppVersion?.version==='3.0.3'},
