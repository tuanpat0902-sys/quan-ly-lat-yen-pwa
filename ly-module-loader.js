(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.35',test:()=>window.__lyAppVersion?.version==='3.0.35'},
    ...
    vibeBusinessWrites:{src:'./ly-vibe-business-writes.js?v=20260909.2',test:()=>window.__lyVibeBusinessWrites?.version==='2026.09.09.2'&&!window.__lyVibeBusinessWrites?.installing},
