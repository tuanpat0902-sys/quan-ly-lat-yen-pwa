(()=>{
  'use strict';
  if(window.__lyModuleLoaderV65)return;
  window.__lyModuleLoaderV65=true;

  const VERSION='2026.08.27.16';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.78',test:()=>window.__lyAppVersion?.version==='2.1.78'},
