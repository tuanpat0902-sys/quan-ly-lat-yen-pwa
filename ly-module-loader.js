(()=>{
  'use strict';
  if(window.__lyModuleLoaderV63)return;
  window.__lyModuleLoaderV63=true;

  const VERSION='2026.08.27.14';
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=2.1.76',test:()=>window.__lyAppVersion?.version==='2.1.76'},
