(()=>{
  ...
  const modules={
    ...
    ingredientConversionSync:{src:'./ly-ingredient-conversion-sync.js?v=20260825.2',test:()=>window.__lyIngredientConversionSync?.version==='2026.08.25.2'},
