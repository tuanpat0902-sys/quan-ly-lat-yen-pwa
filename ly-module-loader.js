(()=>{
  ...
  const modules={
    ...
    vibeBusinessWrites:{src:'./ly-vibe-business-writes.js?v=20260908.4',test:()=>window.__lyVibeBusinessWrites?.version==='2026.09.08.4'&&!window.__lyVibeBusinessWrites?.installing},
