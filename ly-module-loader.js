(()=>{
  ...
  const modules={
    ...
    appVersion:{src:'./ly-app-version.js?v=3.0.40',test:()=>window.__lyAppVersion?.version==='3.0.40'},
    ...
    vibeBusinessWrites:{src:'./ly-vibe-business-writes.js?v=20260919.1',test:()=>window.__lyVibeBusinessWrites?.version==='2026.09.19.1'&&!window.__lyVibeBusinessWrites?.installing},
