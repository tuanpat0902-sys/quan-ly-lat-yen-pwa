...
function loadV4(){
  if(window.__lyChatStockCommandNormalizerV4?.version==='2026.08.25.5')return Promise.resolve(true);
  ...
  window.__lyChatStockCommandNormalizerV4Loading=new Promise(resolve=>{
    ...
    script.src='./ly-chat-stock-command-normalizer-v4.js?v=20260825.5';
    script.async=false;
