(()=>{
  ...
  const REPORT_SIGNALS=/(bao cao|thong ke|tong quan|doanh thu|doanh so|tien ban|tong ban|ban ra|ton kho|thu chi|tien vao tien ra|thu vao chi ra|dong tien|chi phi|nhap xuat|ban chay|top mon|mon chay nhat|mon ban nhieu nhat|loi nhuan|lai nhuan|lai rong|lai lo|profit|bang luong|quy luong|tien luong|luong nhan vien|luong nv|so voi|so sanh|trung binh|binh quan|tang hay giam|giam manh)/;
  ...
  const MAPPINGS=[
    ...
    ['ton khp','tồn kho'],['ton khoo','tồn kho'],['tien vao tien ra','thu chi'],['thu vao chi ra','thu chi'],
    ['top mon','món bán chạy'],['mon chay nhat','món bán chạy'],['mon ban nhieu nhat','món bán chạy'],['lai nhuan','lợi nhuận'],['loi nhan','lợi nhuận'],['profit','lợi nhuận'],['luong nv','lương nhân viên'],
  ...
  const loadInventoryQueries=()=>loadScript('__lyChatInventoryQuery','2026.09.21.1','./ly-chat-inventory-query.js?v=20260921.1','data-ly-chat-inventory-query');
  const loadSalesQueries=()=>loadScript('__lyChatSalesQuery','2026.09.21.1','./ly-chat-sales-query.js?v=20260921.1','data-ly-chat-sales-query');
  const loadSalesInsights=()=>loadScript('__lyChatSalesInsights','2026.09.21.1','./ly-chat-sales-insights.js?v=20260921.1','data-ly-chat-sales-insights');
  const loadRouter=()=>loadScript('__lyChatRouter','2026.09.21.1','./ly-chat-router.js?v=20260921.1','data-ly-chat-router');
