(()=>{
  ...
  const MAPPINGS=[
    ...
    ['bua nay','hôm nay'],['bua qua','hôm qua'],['hom qia','hôm qua'],['tuan roi','tuần trước'],['thang roi','tháng trước'],['quy roi','quý trước'],['nam ngoai','năm trước'],['tuan trc','tuần trước'],['thang trc','tuần trước']
  ];
