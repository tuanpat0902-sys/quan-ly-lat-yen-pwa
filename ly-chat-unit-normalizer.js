...
async function ready(){
  ...
  if(window.__lyChatStockCommandNormalizer?.version!=='2026.08.25.2')await loadScript('./ly-chat-stock-command-normalizer.js?v=20260825.2','__lyChatStockCommandNormalizerLoadingV2');
  return true;
}
