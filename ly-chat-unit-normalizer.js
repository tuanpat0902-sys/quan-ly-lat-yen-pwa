...
async function ready(){
  ...
  if(window.__lyChatStockCommandNormalizer?.version!=='2026.08.25.3')await loadScript('./ly-chat-stock-command-normalizer.js?v=20260825.3','__lyChatStockCommandNormalizerLoadingV3');
  return true;
}
