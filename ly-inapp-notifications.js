(()=>{
  ...
  function requestAppVersion(){
    ...
    try{if(typeof document==='undefined'||!document.createElement)return;const script=document.createElement('script');script.src='./ly-app-version.js?v=2.1.83';script.async=false;(document.head||document.documentElement||document.body)?.appendChild(script);}catch(e){}
  }
