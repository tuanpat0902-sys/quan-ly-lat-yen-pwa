(()=>{
  'use strict';
  const VERSION='3.0.12',REVISION='fresh-core-v3-shell-authoritative-v14',UI_BUILD='UI-2026.08.28.16';
  ...
  const ensureTableViewV2=()=>ensureScript(()=>window.__lyTableViewV2?.version==='2026.08.28.5','./ly-table-view-v2.js?v=20260828.5','table-view-v2');
