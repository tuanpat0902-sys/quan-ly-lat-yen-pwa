...
function showUpdateNotice(){
  ...
  const detail=previous?`Đã cập nhật phần mềm từ Ver ${previous} lên Ver ${VERSION}. Fresh Core V2 dùng auth shim sớm để không bị chặn bởi V260.`:`Phần mềm đang sử dụng Ver ${VERSION} · Fresh Core V2.`;
