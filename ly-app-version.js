(()=>{
  'use strict';
  const VERSION='3.0.12',REVISION='fresh-core-v3-shell-authoritative-v14',UI_BUILD='UI-2026.08.30.36';
  ...
  const ensureUITableErgonomics=()=>ensureScript(()=>window.__lyUITableErgonomics?.version==='2026.08.30.1','./ly-ui-table-ergonomics.js?v=20260830.1','ui-table-ergonomics');
  const ensureTableViewV2=()=>ensureScript(()=>window.__lyTableViewV2?.version==='2026.08.30.1','./ly-table-view-v2.js?v=20260830.1','table-view-v2');
