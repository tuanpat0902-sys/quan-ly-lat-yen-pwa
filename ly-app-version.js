...
function showUpdateNotice(){
  ...
  const detail=previous?`Đã cập nhật phần mềm từ Ver ${previous} lên Ver ${VERSION}. Fresh Core V2 bootstrap được nạp trực tiếp trước Final Ownership.`:`Phần mềm đang sử dụng Ver ${VERSION} · Fresh Core V2.`;
