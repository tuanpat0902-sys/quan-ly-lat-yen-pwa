(()=>{
  'use strict';
  const VERSION='2.1.42',REVISION='fresh-core-v2-authoritative-v43';
  ...
  function showUpdateNotice(){
    ...
    const detail=previous
      ?`Đã cập nhật từ Ver ${previous} lên Ver ${VERSION}. Thêm Trợ lý Lát Yên với lịch sử trên thiết bị và luồng bản nháp có xác nhận.`
