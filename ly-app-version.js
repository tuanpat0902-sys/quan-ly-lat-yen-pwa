(()=>{
  'use strict';
  const VERSION='3.0.12',REVISION='fresh-core-v3-shell-authoritative-v14',UI_BUILD='UI-2026.08.28.9';
  ...
  const ensureUITableErgonomics=()=>ensureScript(()=>window.__lyUITableErgonomics?.version==='2026.08.28.3','./ly-ui-table-ergonomics.js?v=20260828.3','ui-table-ergonomics');
