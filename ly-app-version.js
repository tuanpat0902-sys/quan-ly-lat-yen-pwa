(()=>{
  'use strict';
  const VERSION='2.1.41',REVISION='fresh-core-v2-authoritative-v42';
  ...
  function showUpdateNotice(){
    ...
    const detail=previous
      ?`Đã cập nhật từ Ver ${previous} lên Ver ${VERSION}. Kho mới giờ được tạo trống hoàn toàn, không tự thêm toàn bộ nguyên liệu.`
