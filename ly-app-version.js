(()=>{
  'use strict';
  const VERSION='2.1.44',REVISION='fresh-core-v2-authoritative-v45';
  ...
  function showUpdateNotice(){
    ...
    const detail=previous
      ?`Đã cập nhật từ Ver ${previous} lên Ver ${VERSION}. Trợ lý nhận diện phiếu chính xác hơn, hỏi lại khi tên mặt hàng chưa rõ và để bạn kiểm tra lời nói trước khi gửi.`
