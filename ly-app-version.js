(()=>{
  'use strict';
  const VERSION='3.0.12',REVISION='fresh-core-v3-shell-authoritative-v14',UI_BUILD='UI-2026.08.29.31';
  ...
  const ensureTableViewV2=()=>ensureScript(()=>window.__lyTableViewV2?.version==='2026.08.29.7','./ly-table-view-v2.js?v=20260829.7','table-view-v2');
