(()=>{
  'use strict';
  const VERSION='2.1.47',REVISION='fresh-core-v2-authoritative-v48';
  ...
  function showUpdateNotice(){
    ...
    const detail=previous
      ?`Đã cập nhật từ Ver ${previous} lên Ver ${VERSION}. Trợ lý xử lý đồng bộ lựa chọn, hỗ trợ nhiều mặt hàng và hiểu thêm các mốc thời gian tự nhiên.`
