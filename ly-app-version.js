(()=>{
  'use strict';
  const VERSION='2.1.43',REVISION='fresh-core-v2-authoritative-v44';
  ...
  function showUpdateNotice(){
    ...
    const detail=previous
      ?`Đã cập nhật từ Ver ${previous} lên Ver ${VERSION}. Trợ lý mở đúng form, nhận giọng nói, đọc báo cáo tùy ngày; tồn kho có cảnh báo sắp hết/cần nhập/hết hàng.`
