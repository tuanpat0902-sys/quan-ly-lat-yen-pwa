(()=>{
  'use strict';
  const VERSION='3.0.12',REVISION='fresh-core-v3-shell-authoritative-v14',UI_BUILD='UI-2026.08.30.34';
  ...
  const ensureUITableErgonomics=()=>ensureScript(()=>window.__lyUITableErgonomics?.version==='2026.08.29.7','./ly-ui-table-ergonomics.js?v=20260829.7','ui-table-ergonomics');
