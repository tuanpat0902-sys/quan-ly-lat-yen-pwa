...
export function createEmployeesDomain({gateway,v2Adapter,events}={}){
...
export {createEmployeesRepository,normalizeEmployeeDirectoryRow,EMPLOYEES_DIRECTORY_RPC,EMPLOYEES_DIRECTORY_FIELDS} from './employees-repository.js';
