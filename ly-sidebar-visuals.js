...
const VERSION='2026.08.31.2';
  ...
  /* Biểu tượng chứng từ: nhận biết nhanh, có điểm nhấn tiền tệ đa màu. */
  #nav .nav-icon svg .icon-accent{fill:#f59e0b!important;stroke:#b45309!important;stroke-width:1.25!important}
  #nav .nav-icon svg .icon-accent-mark{fill:none!important;stroke:#fff!important;stroke-width:.9!important;stroke-linecap:round!important}
  #nav button.active .nav-icon svg .icon-accent,#nav button[aria-current="page"] .nav-icon svg .icon-accent{fill:#fff!important;stroke:#fff!important}
  #nav button.active .nav-icon svg .icon-accent-mark,#nav button[aria-current="page"] .nav-icon svg .icon-accent-mark{stroke:#2563eb!important}
