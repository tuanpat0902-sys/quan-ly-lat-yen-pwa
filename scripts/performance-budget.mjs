...
if(indexBytes>1_325_000)fail('index.html exceeded 1.325 MB performance budget');else pass('index.html performance budget');
...
if(!loader.includes("performanceOptimizer:{src:'./ly-performance-optimizer.js?v=20260924.1'"))fail('Performance V4 is not owned by the module loader');
