...
if(indexBytes>1_323_000)fail('index.html exceeded 1.323 MB performance budget');else pass('index.html performance budget');
...
if(!loader.includes("performanceOptimizer:{src:'./ly-performance-optimizer.js?v=20260901.6'"))fail('Performance V4 is not owned by the module loader');
