...
assert.doesNotMatch(settings,/local-readiness-snapshot|V3-2 Consolidated Readiness|V3-3 dependency/,'internal migration readiness must not clutter end-user Settings');
assert.match(settings,/Thông tin phiên bản/,'Settings must retain a compact support-oriented version section');
