...
assert.match(sw,/lat-yen-legacy-ui-fresh-core-47/);
...
assert.match(sw,/ly-fresh-core-v2-masterdata-takeover\.js\?v=20260823\.1/);
...
])assert.ok(sw.includes(`'${asset}'`),`Core-47 must precache ${asset}`);
