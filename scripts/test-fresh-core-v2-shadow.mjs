...
assert.match(sw,/lat-yen-legacy-ui-fresh-core-52/);
...
for(const asset of ['./src-v2/bootstrap.js','./src-v2/domains/inventory/inventory-repository.js','./src-v2/domains/inventory/inventory-service.js','./src-v2/domains/master-data/master-data-repository.js','./src-v2/domains/master-data/master-data-service.js'])assert.ok(sw.includes(`'${asset}'`),`Core-52 must precache ${asset}`);
assert.match(sw,/V2_MASTERDATA_TAKEOVER_SCRIPT/);assert.match(sw,/V2_READ_TAKEOVER_SCRIPT/);assert.match(sw,/p_type\|\|body\?\.p_kind/);
