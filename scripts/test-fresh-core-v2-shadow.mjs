...
assert.match(sw,/lat-yen-legacy-ui-fresh-core-51/);
...
for(const asset of ['./src-v2/bootstrap.js','./src-v2/domains/inventory/inventory-repository.js','./src-v2/domains/inventory/inventory-service.js','./src-v2/domains/master-data/master-data-repository.js','./src-v2/domains/master-data/master-data-service.js'])assert.ok(sw.includes(`'${asset}'`),`Core-51 must precache ${asset}`);
