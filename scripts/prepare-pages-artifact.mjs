...
const REVISION='fresh-core-v2-authoritative-v46';
const LOADER_VERSION='20260824.46';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-99';
...
<script src="./ly-local-chatbot.js?v=20260824.5"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260824.5')],
