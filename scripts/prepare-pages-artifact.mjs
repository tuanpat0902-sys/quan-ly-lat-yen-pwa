...
const REVISION='fresh-core-v2-authoritative-v58';
const LOADER_VERSION='20260825.61';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-119';
...
<script src="./ly-local-chatbot.js?v=20260825.12"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.12')],
