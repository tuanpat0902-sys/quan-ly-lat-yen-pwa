...
const REVISION='fresh-core-v2-authoritative-v53';
const LOADER_VERSION='20260825.56';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-114';
...
<script src="./ly-local-chatbot.js?v=20260825.7"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.7')],
