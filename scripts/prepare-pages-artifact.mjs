...
const REVISION='fresh-core-v2-authoritative-v63';
const LOADER_VERSION='20260825.67';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-124';
...
<script src="./ly-local-chatbot.js?v=20260825.16"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.16')],
