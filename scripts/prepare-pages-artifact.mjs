...
const REVISION='fresh-core-v2-authoritative-v50';
const LOADER_VERSION='20260825.53';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-111';
...
<script src="./ly-local-chatbot.js?v=20260825.4"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.4')],
