...
const REVISION='fresh-core-v2-authoritative-v49';
const LOADER_VERSION='20260825.49';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-102';
...
<script src="./ly-local-chatbot.js?v=20260825.3"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.3')],
