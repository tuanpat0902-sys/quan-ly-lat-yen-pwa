...
const REVISION='fresh-core-v2-authoritative-v52';
const LOADER_VERSION='20260825.55';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-113';
...
<script src="./ly-local-chatbot.js?v=20260825.6"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.6')],
