...
const REVISION='fresh-core-v2-authoritative-v66';
const LOADER_VERSION='20260825.68';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-127';
...
<script src="./ly-compact-admin-layout.js?v=20260825.3"></script>
