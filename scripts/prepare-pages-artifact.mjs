...
const REVISION='fresh-core-v2-authoritative-v57';
const LOADER_VERSION='20260825.60';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-118';
...
<script src="./ly-local-chatbot.js?v=20260825.11"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.11')],
