...
const REVISION='fresh-core-v2-authoritative-v47';
const LOADER_VERSION='20260825.47';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-100';
...
<script src="./ly-local-chatbot.js?v=20260825.1"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.1')],
