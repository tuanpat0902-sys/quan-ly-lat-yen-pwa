...
const REVISION='fresh-core-v2-authoritative-v48';
const LOADER_VERSION='20260825.48';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-101';
...
<script src="./ly-local-chatbot.js?v=20260825.2"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.2')],
