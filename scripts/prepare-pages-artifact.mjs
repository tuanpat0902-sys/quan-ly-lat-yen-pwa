...
const REVISION='fresh-core-v2-authoritative-v56';
const LOADER_VERSION='20260825.59';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-117';
...
<script src="./ly-local-chatbot.js?v=20260825.10"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.10')],
