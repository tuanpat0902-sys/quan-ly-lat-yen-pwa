...
const REVISION='fresh-core-v2-authoritative-v51';
const LOADER_VERSION='20260825.54';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-112';
...
<script src="./ly-local-chatbot.js?v=20260825.5"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.5')],
