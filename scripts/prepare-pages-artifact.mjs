...
const REVISION='fresh-core-v2-authoritative-v59';
const LOADER_VERSION='20260825.62';
const SW_CACHE='lat-yen-fresh-core-v2-authoritative-120';
...
<script src="./ly-local-chatbot.js?v=20260825.13"></script>
...
const checks=[
  ...
  ['local assistant',output.includes('ly-local-chatbot.js?v=20260825.13')],
