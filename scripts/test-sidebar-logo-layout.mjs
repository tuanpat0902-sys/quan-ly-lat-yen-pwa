...
if(!block.includes("const VERSION='2026.08.30.4'"))throw new Error('Sidebar visuals version is stale');
...
if(!html.includes('ly-sidebar-visuals.js?v=20260830.4'))throw new Error('Sidebar visuals are not loaded');
