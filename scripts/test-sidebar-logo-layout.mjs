...
if(!block.includes("const VERSION='2026.08.30.1'"))throw new Error('Sidebar visuals version is stale');
...
if(!html.includes('ly-sidebar-visuals.js?v=20260830.1'))throw new Error('Sidebar visuals are not loaded');
...
if(!/#nav>button\[data-panel\],#nav \.nav-submenu button\[data-panel\]\{display:inline-flex!important[\s\S]*min-width:max-content!important[\s\S]*display:inline!important/.test(block))throw new Error('Mobile navigation must show readable labels inside touch-friendly horizontal items');
