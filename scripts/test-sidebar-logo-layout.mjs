...
if(!block.includes("version:'2026.08.24.2'"))throw new Error('Sidebar visuals version is stale');
...
if(!html.includes('ly-sidebar-visuals.js?v=20260824.2'))throw new Error('Sidebar visuals are not loaded');
