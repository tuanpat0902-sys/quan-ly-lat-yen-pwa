...
if(!block.includes("version:'2026.08.29.4'"))throw new Error('Sidebar visuals version is stale');
...
if(!html.includes('ly-sidebar-visuals.js?v=20260829.4'))throw new Error('Sidebar visuals are not loaded');
