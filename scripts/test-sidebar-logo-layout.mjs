...
if(!block.includes("version:'2026.08.29.3'"))throw new Error('Sidebar visuals version is stale');
...
if(!html.includes('ly-sidebar-visuals.js?v=20260829.3'))throw new Error('Sidebar visuals are not loaded');
if(!/@media\(max-width:760px\)[\s\S]*header \.app-logo-slot\{width:44px!important[\s\S]*#nav\{display:flex!important;flex-direction:row!important;flex-wrap:nowrap!important[\s\S]*overflow-x:auto!important/.test(block))throw new Error('Mobile header must use a compact logo and single-row horizontally scrollable navigation');
