...
assert.match(tableView,/FIXED_REFERENCE_CSS[\s\S]*@media\(max-width:1200px\)[\s\S]*min-width:var\(--ly-tv2-reference-width,960px\)!important/,'tablet and phone V2 tables must retain a fixed desktop reference width');
...
assert.match(app,/ly-table-view-v2\.js\?v=20260830\.3/,'V2 asset must be cache-busted');
...
assert.equal(release.uiBuild,'UI-2026.09.01.48');
assert.equal(release.serviceWorker,'lat-yen-fresh-core-v3-authoritative-240');
