...
for(const shape of ['warehouse_id:wid','attendance_mode','base_salary','hourly_rate','standard_days','bank_account','id_number','time_slots','overtime_slots','daily_bonus','daily_penalty','allowance','bonus','deduction']){
