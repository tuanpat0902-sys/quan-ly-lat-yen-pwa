...
assert.match(appVersion,/REVISION='fresh-core-v3-shell-authoritative-v16'/,'app boot revision must advance with the current release');
...
assert.match(sw,/lat-yen-fresh-core-v3-authoritative-238/,'current service worker release must continue invalidating cached false-positive parity runner bytes');
