...
assert.match(appVersion,/REVISION='fresh-core-v3-shell-authoritative-v65'/,'app boot revision must advance with the current release');
...
assert.match(sw,/lat-yen-fresh-core-v3-authoritative-288/,'current service worker release must continue invalidating cached false-positive parity runner bytes');
