...
assert.match(sw,/lat-yen-fresh-core-v3-authoritative-254/,'current service worker release must continue invalidating cached false-positive parity runner bytes');
