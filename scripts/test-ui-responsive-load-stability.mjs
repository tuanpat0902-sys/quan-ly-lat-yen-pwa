...
assert.match(app,/UI_BUILD='UI-2026\.08\.28\.11'/,'visible deep table optimization marker missing');
assert.match(app,/ly-ui-table-ergonomics\.js\?v=20260828\.5/,'table ergonomics asset must be deterministic');
assert.match(sw,/lat-yen-fresh-core-v3-authoritative-203/,'UI build 11 must force a fresh service-worker release');
