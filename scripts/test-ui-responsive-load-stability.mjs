...
assert.match(app,/UI_BUILD='UI-2026\.08\.31\.39'/,'visible menu icon release marker missing');
assert.match(app,/ly-ui-table-ergonomics\.js\?v=20260830\.2/,'table ergonomics asset must be deterministic');
assert.match(sw,/lat-yen-fresh-core-v3-authoritative-231/,'UI build 39 must force a fresh service-worker release');
