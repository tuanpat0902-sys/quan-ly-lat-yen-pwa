...
assert.match(app,/UI_BUILD='UI-2026\.08\.28\.13'/,'visible Table View V2 wave 2 marker missing');
assert.match(app,/ly-ui-table-ergonomics\.js\?v=20260828\.5/,'table ergonomics asset must be deterministic');
assert.match(sw,/lat-yen-fresh-core-v3-authoritative-205/,'UI build 13 must force a fresh service-worker release');
