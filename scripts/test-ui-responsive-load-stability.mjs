...
assert.match(app,/UI_BUILD='UI-2026\.08\.28\.12'/,'visible Table View V2 foundation marker missing');
assert.match(app,/ly-ui-table-ergonomics\.js\?v=20260828\.5/,'table ergonomics asset must be deterministic');
assert.match(sw,/lat-yen-fresh-core-v3-authoritative-204/,'UI build 12 must force a fresh service-worker release');
