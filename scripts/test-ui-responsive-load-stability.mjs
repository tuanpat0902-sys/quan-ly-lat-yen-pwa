...
assert.match(app,/UI_BUILD='UI-2026\.08\.29\.27'/,'mobile menu containment release marker missing');
assert.match(app,/ly-ui-table-ergonomics\.js\?v=20260829\.6/,'table ergonomics asset must be deterministic');
assert.match(sw,/lat-yen-fresh-core-v3-authoritative-219/,'UI build 27 must force a fresh service-worker release');
