...
assert.match(app,/UI_BUILD='UI-2026\.09\.25\.2'/,'current Vibe release marker missing');
assert.match(app,/ly-ui-table-ergonomics\.js\?v=20260920\.1/,'table ergonomics asset must be deterministic');
assert.match(sw,/lat-yen-fresh-core-v3-authoritative-292/,'the current UI build must force a fresh service-worker release');
