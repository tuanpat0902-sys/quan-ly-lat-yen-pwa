...
if(!/menuSecurity:\{src:'\.\/ly-menu-security\.js\?v=20260921\.1'/.test(fs.readFileSync(new URL('../ly-module-loader.js',import.meta.url),'utf8')))throw new Error('Security cache query was not bumped');
