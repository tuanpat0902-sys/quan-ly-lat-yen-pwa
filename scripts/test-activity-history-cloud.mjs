...
const query={select(){return this;},eq(){return this;},order(){return this;},range(){return Promise.resolve({data:cloudRows,error:null});}};
...
if(!source.includes("range(from,from+PAGE_SIZE-1)"))throw new Error('Cloud activity history must load the next page only when requested');
