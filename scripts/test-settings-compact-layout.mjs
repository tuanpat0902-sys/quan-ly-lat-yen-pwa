...
assert.match(enhancements,/Fresh Core V3 · kiểm tra nền/,'Settings must expose local-only V3 shadow status');
assert.match(enhancements,/1 lần \/ 24 giờ · 2 truy vấn nhỏ/,'Settings must disclose the zero-cost shadow budget');
assert.match(enhancements,/2026\.08\.27\.1/,'settings enhancement cache version must be current');
