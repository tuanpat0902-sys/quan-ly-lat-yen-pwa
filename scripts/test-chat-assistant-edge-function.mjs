...
window.sb={functions:{async invoke(name,request){assert.equal(name,'lat-yen-chat');assert.equal(request.body.message,'Hôm nay nên làm gì?');return {data:{answer:'Bạn nên kiểm tra tồn kho trước nhé.'},error:null};}}};
