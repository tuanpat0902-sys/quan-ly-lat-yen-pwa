(()=>{
  'use strict';
  if(window.__lyUISalesWorkflow?.version==='2026.08.28.2')return;
  const VERSION='2026.08.28.2',STYLE_ID='lyUiSalesWorkflowStyle';
  const CSS=`
...
`;
  ...
  window.__lyUISalesWorkflow=Object.freeze({version:VERSION,mount,status:()=>({version:VERSION,mounted:!!document.getElementById?.(STYLE_ID),layoutOwnership:false})});
})();