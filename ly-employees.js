...
(()=>{
  ...
  function renderEmployees(){
    ...
    if(E.employees.contains(focused)&&focused?.matches?.('input,textarea,select,[contenteditable="true"]')){
              ...
              ${list.map((e,index)=>`
                <tr class="employee-list-row">
                  ...
                  <td class="right employee-row-actions">
                    ...
                    <button type="button" class="danger sm" onclick="deleteEmployee('${e.id}')">Xóa</button>
                  </td>
                </tr>
              `).join('')}
            </table>
