...
(()=>{
  ...
  if(!document.getElementById?.('lyEmployeeLayoutStyles')){const style=document.createElement('style');style.id='lyEmployeeLayoutStyles';style.textContent=`.employee-salary-chart-grid{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(0,.92fr);align-items:stretch;gap:12px}.employee-salary-chart-grid>.card{margin-top:0!important;min-width:0;padding:14px!important}.employee-salary-chart-grid .employee-section-head{min-height:56px;align-items:flex-start}.employee-salary-chart-grid .employee-section-head h3{font-size:var(--ly-font-md,14px)!important}.employee-salary-chart-grid .muted{font-size:var(--ly-font-sm,11px)!important}.employee-salary-card .salary-report-table-wrap,.employee-salary-card .salary-report-scroll,.employee-salary-card .salary-report-actions{width:100%!important;max-width:none!important}.employee-salary-card .salary-report-table{width:100%!important;max-width:none!important;font-size:var(--ly-font-base,12px)!important}.employee-salary-card .salary-report-table th{font-size:var(--ly-font-sm,11px)!important}.employee-work-chart-card canvas{display:block;margin-top:6px}@media(max-width:1180px){.employee-salary-chart-grid{grid-template-columns:1fr}}`;document.head.appendChild(style);}
