...
const ASSETS=[INDEX_KEY,'./manifest.webmanifest','./icon.svg',SETTINGS_SCRIPT,NOTIFICATION_SCRIPT,INAPP_SCRIPT,CENTER_SCRIPT,UNIFIED_STATUS_SCRIPT,MENU_SECURITY_SCRIPT,BRANDING_SCRIPT];
