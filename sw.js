const CACHE='lat-yen-legacy-ui-fresh-core-12';
...
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg',NOTIFICATION_SCRIPT,INAPP_SCRIPT,CENTER_SCRIPT];
