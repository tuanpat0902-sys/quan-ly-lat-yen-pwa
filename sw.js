const CACHE='lat-yen-legacy-ui-fresh-core-46';
...
async function navigationWithLayers(request){const response=await navigationSource(request);if(!response)return response;const type=response.headers.get('content-type')||'';if(!type.includes('text/html'))return response;try{let html=await response.text();const scripts=[];if(!html.includes('ly-module-loader.js'))scripts.push('<script src="./ly-module-loader.js?v=20260823.8"></script>');if(!html.includes('ly-history-bridge.js'))scripts.push('<script src="./ly-history-bridge.js?v=20260823.1"></script>');if(!html.includes('ly-employees-bridge.js'))scripts.push('<script src="./ly-employees-bridge.js?v=20260823.1"></script>');if(!html.includes('ly-finance-bridge.js'))scripts.push('<script src="./ly-finance-bridge.js?v=20260823.1"></script>');if(!html.includes('ly-reports-bridge.js'))scripts.push('<script src="./ly-reports-bridge.js?v=20260823.1"></script>');if(!html.includes('ly-settings-ui-bridge.js'))scripts.push('<script src="./ly-settings-ui-bridge.js?v=20260823.1"></script>');if(!html.includes('ly-cashflow-bridge.js'))scripts.push('<script src="./ly-cashflow-bridge.js?v=20260823.1"></script>');if(!html.includes('ly-special-reports-bridge.js'))scripts.push('<script src="./ly-special-reports-bridge.js?v=20260823.1"></script>');if(!html.includes('ly-employee-reports-bridge.js'))scripts.push('<script src="./ly-employee-reports-bridge.js?v=20260823.1"></script>');if(!html.includes('ly-data-notifications.js'))scripts.push('<script src="./ly-data-notifications.js?v=20260823.6"></script>');if(!html.includes('ly-inapp-notifications.js'))scripts.push('<script src="./ly-inapp-notifications.js?v=20260823.5"></script>');if(!html.includes('ly-notification-center.js'))scripts.push('<script src="./ly-notification-center.js?v=20260823.3"></script>');if(!html.includes('ly-cloud-realtime.js'))scripts.push('<script src="./ly-cloud-realtime.js?v=20260823.4"></script>');if(!html.includes('ly-menu-security.js'))scripts.push('<script src="./ly-menu-security.js?v=20260823.1.4"></script>');if(!html.includes('ly-performance-optimizer.js'))scripts.push('<script src="./ly-performance-optimizer.js?v=20260823.4"></script>');if(!html.includes('ly-fresh-core-v2-shadow.js'))scripts.push('<script src="./ly-fresh-core-v2-shadow.js?v=20260823.2"></script>');if(!html.includes('ly-fresh-core-v2-ingredients-takeover.js'))scripts.push('<script src="./ly-fresh-core-v2-ingredients-takeover.js?v=20260823.1"></script>');if(!html.includes('ly-fresh-core-v2-products-takeover.js'))scripts.push('<script src="./ly-fresh-core-v2-products-takeover.js?v=20260823.1"></script>');if(!html.includes('ly-fresh-core-v2-documents-takeover.js'))scripts.push('<script src="./ly-fresh-core-v2-documents-takeover.js?v=20260823.1"></script>');if(!html.includes('ly-fresh-core-v2-sales-takeover.js'))scripts.push('<script src="./ly-fresh-core-v2-sales-takeover.js?v=20260823.1"></script>');if(!html.includes('ly-fresh-core-v2-cashflow-takeover.js'))scripts.push('<script src="./ly-fresh-core-v2-cashflow-takeover.js?v=20260823.1"></script>');if(!html.includes('ly-fresh-core-v2-realtime.js'))scripts.push('<script src="./ly-fresh-core-v2-realtime.js?v=20260823.1"></script>');if(!html.includes('ly-fresh-core-v2-realtime-phase2.js'))scripts.push('<script src="./ly-fresh-core-v2-realtime-phase2.js?v=20260823.1"></script>');if(scripts.length){const block=scripts.join('\n');html=/<\/body>/i.test(html)?html.replace(/<\/body>/i,block+'\n</body>'):html+'\n'+block;}const headers=new Headers(response.headers);headers.delete('content-length');headers.delete('content-encoding');headers.delete('etag');headers.set('content-type','text/html; charset=utf-8');return new Response(html,{status:response.status,statusText:response.statusText,headers});}catch(e){return response;}}
