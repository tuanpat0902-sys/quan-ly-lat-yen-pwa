const CACHE='lat-yen-fresh-core-v3-authoritative-288';
...
const PRECACHE_ASSETS=[
  ...
  './ly-ui-form-ergonomics.js?v=20260922.2',
...
async function navigationSource(request){try{return await refreshNavigation(request);}catch(e){return caches.match(INDEX_KEY);}}
