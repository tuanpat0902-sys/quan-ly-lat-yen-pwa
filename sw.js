const CACHE='lat-yen-legacy-ui-fresh-core-30';
...
async function navigationWithLayers(request){
  ...
  try{
    ...
    if(!html.includes('ly-module-loader.js'))scripts.push('<script src="./ly-module-loader.js?v=20260823.5"></script>');
